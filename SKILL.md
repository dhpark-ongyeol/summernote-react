...
This skill describes `@eaeao/summernote-react@1.3.0`, a React + TypeScript port of the summernote WYSIWYG editor — the editing engine and React bindings in one npm package, **zero runtime dependencies, no jQuery, no `document.execCommand`**. It is a normal React component, not a jQuery plugin.
