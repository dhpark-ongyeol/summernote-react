...
export const EXAMPLES: Example[] = [
  ...
  { id: 'air', emoji: '✈️', title: 'Air mode', group: 'Features', blurb: 'No fixed toolbar — a floating toolbar appears at the selection (below it on touch).', Component: AirModeEx },
  ...
  { id: 'i18n', emoji: '🌐', title: 'Localization', group: 'Features', blurb: '46 bundled locales, deep-merged over en-US. Pass one via the lang prop.', Component: Localization },
  { id: 'image', emoji: '🖼️', title: 'Insert image', group: 'Features', blurb: 'The picture dialog inserts a file as a data-URL (or an image URL) — no server needed.', Component: ImageUpload },
  { id: 'multiple', emoji: '🧩', title: 'Multiple editors', group: 'Recipes', blurb: 'Several independent editors on one page, each with its own theme and state.', Component: Multiple },
  ...
  { id: 'plugin', emoji: '🔌', title: 'Custom button / plugin', group: 'Recipes', blurb: 'definePlugin adds per-instance commands + custom toolbar buttons (here: highlight + timestamp).', Component: PluginEx },
  { id: 'ref', emoji: '🎛️', title: 'Imperative API', group: 'Recipes', blurb: 'A ref exposes getCode / setCode / command / focus / undo / redo.', Component: ImperativeRef },
];
