...
Guidance for AI coding agents integrating this package. This document describes `@eaeao/summernote-react@1.3.0`. It ships its own TypeScript declarations — treat the bundled `.d.ts` as the source of truth; this file is the orientation.
